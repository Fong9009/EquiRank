...
--
-- Host: localhost:3306
-- Generation Time: Sep 24, 2025 at 10:04 AM
...
CREATE TABLE `company_values` (
  ...
  `company_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Name of company',
  `industry` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Industry of Company',
  `company_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_instagram` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_facebook` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `revenue_range` enum('0-50k','50k-100k','100k-500k','500k-1m','1m-5m','5m-10m','10m-50m','50m+') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Annual revenue range',
...
(23, 2, 1, 10000.00, 'AUD', NULL, NULL, 'To buy new computers', 'equipment', 'pending', '2025-09-24 02:27:15', '2025-09-24 02:27:15', '2025-09-30 00:00:00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, 2, 2, 20000.00, 'AUD', '', NULL, 'Buying a new office space for the team to expand our operations', 'expansion', 'pending', '2025-09-24 02:27:35', '2025-09-24 02:28:29', '2025-09-30 00:00:00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(3, 'lender1@bank.com', '$2b$12$gvpowO.QzOeSMOXl58X17ebpyF5/AZEZbXQf77x5wWkS8y.cOeZBW', 'Jane', 'Doe', 'lender', 'Investment Bank Ltd', '+1234567892', '789 Finance Blvd, Bank City', 1, 1, 0, 0, NULL, '', 'I am a lender willing to help small businesses grow', 'dark', 'en', 'UTC', NULL, '2025-08-10 11:54:38', '2025-09-24 07:33:50'),
